                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form action="add_book.php" method="POST">
                            ...
                            <input type="text" name="t1" title="Enter only Characters" maxlength="200" required><br>

                            <label>Subject: </label>
                            <input type="text" name="t2" title="Enter only Characters" maxlength="32" pattern="[A-Za-z]{1,32}" required><br>

                            <label>Writter Name: </label>
                            <input type="text" name="t3" title="Enter only Characters" maxlength="200"  required><br>
                            ...
                            <input type="text" name="t5" title="Enter only Integers" maxlength="4" pattern="[0-9]{1,4}" required><br>
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/add-book.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Oct 2020 13:58:24 GMT -->
</html>