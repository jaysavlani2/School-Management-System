                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form enctype="multipart/form-data" method="POST">
                            ...
                            <label>E-Mail: </label>
                            <input type="email" name="t7" maxlength="50" title="For Ex: jaysavlani2@gmail.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required><br>
                            ...
                            <label>Address</label>
                            <input type="text" maxlength="200" name="t10" required><br>
       
                            <label>Phone: </label>
                            <input type="text" name="t11" title="Enter Ten Integers" maxlength="10" pattern="[0-9]{10}" required><br>

                            <label>Short BIO: </label>
                            <textarea name="t12" maxlength="200" required></textarea><br>
...
<?php
    ...
    if(isset($_POST['b1']))
    {
        ...
        {
            $sql ="insert into add_teacher (fname,lname,gender,join_date,bgroup,religion,email,class,address,phone,bio,teacher_photo) values ('".$t1."','".$t2."','".$t3."','".$t4."','".$t5."','".$t6."','".$t7."','".$t8."','".$t10."','".$t11."','".$t12."','".$name."')";
