                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <!--FETCHING DATA FROM EACH  
                                        ...
                                        <td><?php echo $rows['writter_name'];?></td>
                                        <td><?php echo $rows['class'];?></td>
                                        <td><?php echo $rows['pub_year'];?></td>
                                        <td><?php echo $rows['up_date'];?></td>
                                        <td><a href="edit-book.php?id=<?php echo $rows['id']; ?>" alt="edit" >Edit</a></td>
                                        <td><a href="delete-book.php?delete=<?php echo $rows['id']; ?>" alt="delete">Delete</a></td>
                                        <td></td>
                                    </tr> 
                                    <?php 
                                        } 
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/all-book.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Oct 2020 13:58:24 GMT -->
</html>