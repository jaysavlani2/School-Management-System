                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="edit-student.php?roll=<?php echo $rows['roll']; ?>" alt="edit" >Edit</a></td>
                                        <td><a href="delete-student.php?delete=<?php echo $rows['roll']; ?>" alt="delete">Delete</a></td>
                                        <td></td>
                                    </tr> 
                                        <?php 
                                            } 
