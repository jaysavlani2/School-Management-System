                                    ...
                                    <table class="table display data-table text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="edit-subject.php?id=<?php echo $rows['id']; ?>" alt="edit" >Edit</a></td>
                                                <td><a href="delete-subject.php?delete=<?php echo $rows['id']; ?>" alt="delete">Delete</a></td>
                                                <td></td>
                                            </tr>
                                            <?php 
                                                } 
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/all-subject.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Oct 2020 13:58:24 GMT -->
</html>