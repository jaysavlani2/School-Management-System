                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tr> 
                                    ...
                                    <td><a href="edit-teacher.php?id=<?php echo $rows['id']; ?>" alt="edit" >Edit</a></td>
                                    <td><a href="delete-teacher.php?delete=<?php echo $rows['id']; ?>" alt="delete">Delete</a></td> 
                                    <td></td>   
                                </tr> 
                                <?php 
                                    } 
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/all-teacher.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Oct 2020 13:58:23 GMT -->
</html>