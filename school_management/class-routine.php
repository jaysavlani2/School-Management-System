<?php
    ...
    $sql = "SELECT * FROM add_classroutine"; 
...
<style>
    input[type=text],[type=email],[type=date],[type=file],[type=time], select {
        width: 100%;
        padding: 12px 20px;
        margin: 8px 0;
                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form action="add_classroutine.php" method="POST">
        
                                    <label>Teacher Name: </label>
                                    <input type="text" name="t1" maxlength="50" pattern="[A-Z a-z]{1,50}" required><br>
    
                                    <label>Subject Name: </label>
                                    <input type="text" name="t2" maxlength="100" pattern="[A-Z a-z]{1,100}" required><br>
                                    ...
                                    <input type="time" name="t4" min="09:00" max="18:00" placeholder="24:00" required><br>

                                    <label>Ending Time: </label>
                                    <input type="time" name="t5" min="09:00" max="18:00" placeholder="24:00" required><br>

                                    <label>Date: </label>
                                    <input type="Date" name="t6" required><br>
                                    ...
                                    <table class="table display data-table text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="edit-classroutine.php?id=<?php echo $rows['id']; ?>" alt="edit" >Edit</a></td>
                                                <td><a href="delete-classroutine.php?delete=<?php echo $rows['id']; ?>" alt="delete">Delete</a></td>
                                                <td></td>
                                            </tr>
                                            <?php 
                                                } 
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/class-routine.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Oct 2020 13:58:24 GMT -->
</html>