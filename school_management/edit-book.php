<?php
  ...
  if(isset($_GET['id'])){
    $sql = "SELECT * FROM add_book WHERE id =" .$_GET['id'];
  ...
  if(isset($_POST['btn-update'])){
    ...
    $update = "UPDATE add_book SET book_name='$book_name',subject='$subject',writter_name='$writter_name',class='$class',pub_year='$pub_year',up_date='$up_date' WHERE id=". $_GET['id'];
    $up = mysqli_query($conn, $update);
?>
    <script type="text/javascript">
      window.location.replace("all-book.php");
    </script>
<?php
  }
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>
                          <a href="all-book.php">All Library Books</a>
                        </li>
                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                          ...
                          <form method="post">
                            ...
                            <input type="text" name="book_name" value="<?php echo $row['book_name']; ?>" maxlength="200" required><br><br>

                            <label>Subject: </label>
                            <input type="text" name="subject" value="<?php echo $row['subject']; ?>" maxlength="30" pattern="[A-Za-z]{1,30}" required><br><br>

                            <label>Writter Name: </label>
                            <input type="text" name="writter_name" value="<?php echo $row['writter_name']; ?>" maxlength="200"  required><br>
                            ...
                            <input type="text" name="pub_year" value="<?php echo $row['pub_year']; ?>" title="Enter only Integers" maxlength="4" pattern="[0-9]{1,4}" required><br>

                            <label>Uploade Date: </label>
                            <input type="Date" name="up_date" value="<?php echo $row['up_date']; ?>" required><br>

                            <a href="all-book.php"><button type="submit" name="btn-update" id="btn-update">Update</button></a>
                            <a href="all-book.php"><button type="button" value="button">Cancel</button></a>
                          </form>
                        </div>
                </div>
