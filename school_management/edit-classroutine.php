<?php
  ...
  if(isset($_GET['id'])){
    $sql = "SELECT * FROM add_classroutine WHERE id =" .$_GET['id'];
  ...
  if(isset($_POST['btn-update'])){
    ...
    $update = "UPDATE add_classroutine SET teacher_name='$teacher_name',subject_name='$subject_name',class='$class',st='$st',et='$et',date='$date' WHERE id=". $_GET['id'];
    $up = mysqli_query($conn, $update);
    ?>
<script type="text/javascript">
  window.location.replace("class-routine.php");
</script>
<?php
  }
?>
...
<head>
    ...
    <title>JYG | Edit-ClassRoutine</title>
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>
                          <a href="class-routine.php">Routine</a>
                        </li>
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form method="post">
                          ...
                          <input type="text" name="teacher_name" value="<?php echo $row['teacher_name']; ?>" maxlength="50" pattern="[A-Z a-z]{1,50}" required><br><br>


                          <label>Subject Name: </label>
                          <input type="text" name="subject_name" value="<?php echo $row['subject_name']; ?>" maxlength="100" pattern="[A-Z a-z]{1,100}" required><br>
                          ...
                          <input type="time" name="st" value="<?php echo $row['st']; ?>" min="09:00" max="18:00" placeholder="24:00" required><br>

                          <label>Ending Time: </label>
                          <input type="time" name="et" value="<?php echo $row['et']; ?>" min="09:00" max="18:00" placeholder="24:00" required><br>

                          <label>Date: </label>
                          <input type="Date" name="date" value="<?php echo $row['date']; ?>" required><br>


                          <a href="class-routine.php"><button type="submit" name="btn-update" id="btn-update"><strong>Update</strong></button></a>
                          <a href="class-routine.php"><button type="button" value="button">Cancel</button></a>
                        </form>
                    </div>
                </div>
