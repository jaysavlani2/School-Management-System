<?php
  ...
  if(isset($_GET['id'])){
    $sql = "SELECT * FROM add_account WHERE id =" .$_GET['id'];
  ...
  if(isset($_POST['btn-update'])){
    ...
    $update = "UPDATE add_account SET fname='$fname',lname='$lname',gender='$gender',religion='$religion',bdate='$bdate',phone='$phone',email='$email',password='$password',address='$address' WHERE id=". $_GET['id'];
                    ...
                    <div class="card-body">
                        ...
                        <form method="post">
                          ...
                          <label>Password: </label>
                            <input type="password" value="<?php echo $row['password']; ?>" name="password" pattern="^(?=.*?[A-Z])(?=(.*[a-z]){1,})(?=(.*[\d]){1,})(?=(.*[\W]){1,})(?!.*\s).{8,}$" required><br><br>
                          ...
                          <a href="profile.php"><button type="button" value="button">Cancel</button></a>
                        </form>
                      </div>
                </div>
