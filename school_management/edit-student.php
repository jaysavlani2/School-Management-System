<?php
  ...
  if(isset($_GET['roll'])){
    $sql = "SELECT * FROM add_student WHERE roll =" .$_GET['roll'];
  ...
  if(isset($_POST['btn-update'])){
    ...
    $update = "UPDATE add_student SET fname='$fname',lname='$lname',gender='$gender',class='$class',bdate='$bdate',phone='$phone',email='$email' WHERE roll=". $_GET['roll'];
    $up = mysqli_query($conn, $update);
?>
<script type="text/javascript">
  window.location.replace("all-student.php");
</script>
<?php
  }
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>
                          <a href="all-student.php">All Students</a>
                        </li>
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form method="post">
                          ...
                          <input type="date" name="bdate" value="<?php echo $row['bdate']; ?>" required><br><br>
                          ...
                          <a href="all-student.php"><input type="submit" value="Update" name="btn-update" id="btn-update"></a>
                          <a href="all-student.php"><button type="button" value="button">Cancel</button></a>
                        </form>
                    </div>
                </div>
