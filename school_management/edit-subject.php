<?php
  ...
  if(isset($_GET['id'])){
    $sql = "SELECT * FROM add_subject WHERE id =" .$_GET['id'];
  ...
  if(isset($_POST['btn-update'])){
    ...
    $update = "UPDATE add_subject SET subject_name='$subject_name',class='$class' WHERE id=". $_GET['id'];
    $up = mysqli_query($conn, $update);
    ?>
<script type="text/javascript">
  window.location.replace("all-subject.php");
</script>
<?php
  }
?>
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="all-subject.php" class="nav-link menu-active"><i
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>
                          <a href="all-subject.php">Subjects</a>
                        </li>
                        <li>Edit Subject Information</li>
                    </ul>
                </div>
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form method="post">
                          ...
                          <input type="text" name="subject_name" value="<?php echo $row['subject_name']; ?>" pattern="[A-Z a-z]{1,100}" maxlength="100" required><br><br>
                          ...
                          <a href="all-subject.php"><button type="submit" name="btn-update" id="btn-update">Update</button></a>
                          <a href="all-subject.php"><button type="button" value="button">Cancel</button></a>
                        </form>
                        </div>
                </div>
