<?php
  ...
  if(isset($_GET['id'])){
    $sql = "SELECT * FROM add_teacher WHERE id =".$_GET['id'];
  ...
  if(isset($_POST['btn-update'])){
    ...
    $update = "UPDATE add_teacher SET fname='$fname',lname='$lname',gender='$gender',join_date='$join_date',email='$email',class='$class',address='$address',phone='$phone' WHERE id=". $_GET['id'];
    $up = mysqli_query($conn, $update);
    ?>
    <script type="text/javascript">
      window.location.replace("all-teacher.php");
    </script>
<?php
  }
?>
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>
                          <a href="all-teacher.php">All Teachers</a>
                        </li>
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form method="post">
                          ...
                          <input type="text" name="fname" value="<?php echo $row['fname']; ?>" title="Enter only Characters" maxlength="20" pattern="[A-Za-z]{1,20}" required><br/><br/>

                          <label>Last Name:</label>
                          <input type="text" name="lname" value="<?php echo $row['lname']; ?>" title="Enter only Characters" maxlength="20" pattern="[A-Za-z]{1,20}" required><br/><br/>
                          ...
                          <input type="date" name="join_date" value="<?php echo $row['join_date']; ?>" required><br><br>

                          <label>Email:</label>
                          <input type="email" name="email" value="<?php echo $row['email']; ?>" title="For Ex: jaysavlani2@gmail.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" maxlength="50" required><br/><br/>
                          ...
                          <label>Address</label>
                          <input type="text" maxlength="200" name="address" value="<?php echo $row['address']; ?>" required><br><br>

                          <label>Phone:</label>
                          <input type="text" name="phone" title="Enter Ten Integers" maxlength="10" pattern="[0-9]{10}" value="<?php echo $row['phone']; ?>" required><br/><br/>

                          <a href="all-teacher.php"><button type="submit" name="btn-update" id="btn-update"><strong>Update</strong></button></a>
                          <a href="all-teacher.php"><button type="button" value="button">Cancel</button></a>
                        </form>
                      </div>
                    </div>
