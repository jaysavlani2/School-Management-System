<?php
    ...
    $sql1="select * from add_account where email='$login_session'";
                            ...
                            <div class="card-body">
	                            ...
	                            <div class="item-content">
	                                <div class="header-inline item-header">
	                                    <h3 class="text-dark-medium font-medium"><?php echo $row1['fname'];?>&nbsp;<?php echo $row1['lname'];?></h3>
	                                    <div class="header-elements">
	                                        <ul>
	                                            <li><a href="edit-profile.php?id=<?php echo $row1['id']; ?>"><i class="far fa-edit"></i></a></li>
	                                        </ul>
	                                    </div>
	                                </div>
	                                <!--p><?php echo $row1['shortbio'];?></p-->
	                                <div class="info-table table-responsive">
	                                    <table class="table text-nowrap">
	                                        <tbody>
	                                            <tr>
	                                                <td>Name:</td>
	                                                <td class="font-medium text-dark-medium"><?php echo $row1['fname'];?>&nbsp;<?php echo $row1['lname'];?></td>
	                                            </tr>
	                                            <tr>
	                                                <td>Gender:</td>
	                                                <td class="font-medium text-dark-medium"><?php echo $row1['gender'];?></td>
	                                            </tr>
	                                            <tr>
	                                                <td>Date Of Birth:</td>
	                                                <td class="font-medium text-dark-medium"><?php echo $row1['bdate'];?></td>
	                                            </tr>
	                                            <tr>
	                                                <td>Religion:</td>
	                                                <td class="font-medium text-dark-medium"><?php echo $row1['religion'];?></td>
	                                            </tr>
	                                            <tr>
	                                                <td>E-mail:</td>
	                                                <td class="font-medium text-dark-medium"><?php echo $row1['email'];?></td>
	                                            </tr>
	                                            <tr>
	                                                <td>Password:</td>
	                                                <td class="font-medium text-dark-medium"><?php echo $row1['password'];?></td>
	                                            </tr>
	                                            <tr>
	                                                <td>Admin Type:</td>
	                                                <td class="font-medium text-dark-medium"><?php echo $row1['admin_type'];?></td>
	                                            </tr>
	                                            <tr>
	                                                <td>Phone:</td>
	                                                <td class="font-medium text-dark-medium"><?php echo $row1['phone'];?></td>
	                                            </tr>
	                                            <tr>
	                                                <td>Address:</td>
	                                                <td class="font-medium text-dark-medium"><?php echo $row1['address'];?></td>
	                                            </tr>
	                                        </tbody>
	                                    </table>
	                                </div>
