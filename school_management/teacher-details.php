<?php
    ...
    if( isset($_GET['search']) ){
        ...
        $sql2 = "SELECT * FROM add_teacher WHERE fname ='$name'";
    }
...
<head>
    ...
    <title>JYG | Teacher Details</title>
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <div class="single-info-details">
                            <div class="item-img">
                                <img src="img/<?php echo $row['teacher_photo']; ?>" alt="teacher">
                            </div>
                            <div class="item-content">
                                <div class="header-inline item-header">
                                    ...
                                    <div class="header-elements">
                                        <ul>
                                            <li><a href="edit-teacher.php?id=<?php echo $row['id']; ?>"><i class="far fa-edit"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="info-table table-responsive">
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <tr>
                                                <td>Name:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $row['fname'];?>&nbsp;<?php echo $row['lname'];?></td>
                                            </tr>
                                            <tr>
                                                <td>Gender:</td>
                                            ...
                                            <tr>
                                                <td>Joining Date:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $row['join_date'];?></td>
                                            </tr>
                                            <tr>
                                                <td>E-mail:</td>
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/teacher-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Oct 2020 13:58:23 GMT -->
</html>